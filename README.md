...
> 🚀 Ярлык можно создать вручную или закрепить программу на панели задач.

### Linux 🐧
Для Linux доступен пакет в формате `.deb` (подходит для Ubuntu, Debian и совместимых дистрибутивов).

#### Установка через терминал:
1. Скачайте файл `password-generator_1.5.0_amd64.deb`.
2. Откройте терминал в папке со скачанным файлом и выполните:
   ```bash
   sudo dpkg -i password-generator_1.5.0_amd64.deb
...
> 🚀 You can manually create a shortcut or pin the program to the taskbar.

### Linux 🐧
For Linux, a `.deb` package is available (compatible with Ubuntu, Debian, and derivative distributions).

#### Terminal installation:
1. Download the file `password-generator_1.5.0_amd64.deb`.
